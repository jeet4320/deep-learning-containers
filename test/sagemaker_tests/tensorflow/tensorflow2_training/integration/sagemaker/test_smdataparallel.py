...
def test_smdataparallel_mnist(instance_types, iad_ecr_image, py_version, iad_sagemaker_session, tmpdir):
    """
...
def test_smdataparallel_throughput(instance_types, iad_ecr_image, py_version, iad_sagemaker_session, tmpdir):
    """
